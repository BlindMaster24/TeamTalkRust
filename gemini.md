...
### 1. ?????????? ?????????? (State Management)
- **???????**: ?? ?????????? Mutex<ConnectionState> ?? ??????? ??? ?????????????? ??????????.
- **???????????**: ??????????? ????????????? state_cache: AtomicU32 ??? ???????? (lock-free) ?????? ???????, ?? ?????? ?????? ?????? ????????? ????? Mutex ??? ??????????? ??????????? ?????????.

### 2. ??????????? ?????? (Async Client)
- **??????**: ?????????? ??????? ????? (Worker Thread) + MPSC ?????.
- **??????????**: ??????? SDK (client.poll) ?????????? ? ????????? ??????. ??????? ?????????? ? ??????????? ??????? ????? ?????? ? ?????????? backpressure.
- **????**: ?????? ???????? ???????????? ???????? ?? ???????????? ??????????.

### 3. ??????????? ?????? ? ?????
- **TTString**: ??? ???????? ????? ? SDK ???????????? TTString, ?????????????? ???????? ????????? (512 ????).
- **??????**: ????????? ?????? ????????? Vec ??? String ??? ?????? ?????????????? ? FFI.

### 4. ?????????? API
- **ClientBuilder**: ????????????? ?????? ????????????? ???????.
- **EventData**: ??????? ????? ?????????????? ?????? (TextMessage, User ? ?.?.) ????? ????? .data().
- **Iterators**: ????????? ???????????? ???????? ??????? ????? client.events(timeout).
