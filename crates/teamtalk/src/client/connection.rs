...
mod tests {
    ...
    fn connect_params_from_env_parses_values() {
        unsafe {
            env::set_var("TT_HOST", "example.com");
            env::set_var("TT_TCP", "10443");
            env::set_var("TT_UDP", "10555");
            env::set_var("TT_ENCRYPTED", "true");
        }
        ...
        unsafe {
            env::remove_var("TT_HOST");
            env::remove_var("TT_TCP");
            env::remove_var("TT_UDP");
            env::remove_var("TT_ENCRYPTED");
        }
    }
}
